document.addEventListener('DOMContentLoaded', () => {
	...
	const letters = [
		...
		},
		{
			...
			text: `
             		Мог бы сказать это по телефону или глядя в твои красивые глаза, когда вручал букет, но захотел сделать что-то особенное. Знаю, ты оценишь это, и мне важно, чтобы ты почувствовала, как сильно ты мне нужна. Люблю тебя бесконечно, мой котик! 🩷🩷🩷
	     		`.trim(),
			speed: 50,
		},
	]
