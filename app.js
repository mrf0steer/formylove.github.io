document.addEventListener('DOMContentLoaded', () => {
	...
	const letters = [
		...
		},
		{
			...
			text: `
             Мог сказать это лично или в звонке с тобой когда отдал букет и открытку, но решил креативно подойти к тому что хочу сказать. Я знаю ты оценишь это =) Любля тебя, мой котик ❤️❤️❤️
            `.trim(),
			speed: 50,
		},
	]
