document.addEventListener('DOMContentLoaded', () => {
	...
	const letters = [
		...
		},
		{
			...
			text: `
             		Мог бы сказать это по телефону или глядя в твои красивые глаза, когда буду вручать букет и открытку, но захотел сделать что-то особенное, чтобы ты улыбнулась. Знаю, ты любишь такие штуки, и мне важно, чтобы ты почувствовала, как сильно ты мне нужна. Люблю тебя бесконечно, мой котик! 🩷🩷🩷
	     		`.trim(),
			speed: 50,
		},
	]
