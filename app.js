document.addEventListener('DOMContentLoaded', () => {
	...
	const letters = [
		...
		},
		{
			...
			text: `
             Мог сказать это в звонке или при встрече с тобой когда подарил букет и открытку, но решил креативно подойти к тому что хочу сказать. Я знаю ты оценишь это =) 
            `.trim(),
			speed: 10,
		},
	]
